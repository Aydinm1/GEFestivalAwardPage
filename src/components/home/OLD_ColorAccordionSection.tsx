...
import ColorPaletteCard, { type ColorPanel } from './OLD_ColorPaletteCard.tsx';
import { galleryItems } from './OLD_galleryItems.ts';
import PhotoLightbox from './OLD_PhotoLightbox.tsx';
    ...
    <section className="overflow-hidden bg-white px-6 py-20 md:py-28">
      <div className="mx-auto max-w-7xl">
        <motion.div
          ...
          className="mx-auto mb-10 max-w-3xl text-center md:mx-0 md:mb-14 md:text-left"
        >
          ...
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-slate-500 md:mx-0 md:text-lg">
